...
// MultiByteToWideChar は Windows API でマルチバイト文字列 → ワイド文字列の変換を行う関数
// 2段階で呼ぶ理由  1回目で変換後に何文字必要かを調べ、2回目で実際に変換する
...
// WideCharToMultiByte はワイド文字列 → マルチバイト文字列の変換を行う Windows API 関数
