...
{
    switch (type) {
    case GunType::Magnum:  return kMagnumSet;
    case GunType::SMG:     return kSmgSet;
    case GunType::Shotgun: return kShotgunSet;
    case GunType::Railgun: return kRailgunSet;
    default:               return kPistolSet;
    }
}
